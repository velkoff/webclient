 ...
 * $Id: videostream.js,v 5.6.0 2026/04/05 09:09:09 dc Exp $
 */
...
Box.boxes.AudioSampleEntry.decode = function(buf, offset, end) {
  ...
  if (!box.esds) for (var i = 0; i < length - 4; i++) if (101 === buf[i] && 115 === buf[i + 1] && 100 === buf[i + 2] && 115 === buf[i + 3]) {
    (ptr = Box.boxes.esds.decode(buf, 12 + (offset = i - 4), offset + (end = buf[offset] << 24 | buf[offset + 1] << 16 | buf[offset + 2] << 8 | buf[offset + 3]))).type = "esds";
